...
public class RpDocxTool {
		...
		for (Object objService : services){
			...
			for (Object objHost : hosts){
				...
				for (Object objInstance : instances){
					...
					log.info("engine_disk_usage:{}",getCliResultValue(result, "disk_usage", "engine_disk_usage"));
					...
					*/
					...
					log.info("heap_old_memory_peak_usage_map:" + heap_old_memory_peak_usage_map);
	...
	public void createInstanceResultTable(HashMap<String, Object> map) throws Exception {
		...
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("service_name"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 15);
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("hostname"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 35);
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("instance_name"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 15);
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("jboss_version"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 35);
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("java_version"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 35);
		addTableCellWidth(factory, wordMLPackage, table1_row2, (String)map.get("instance_ip"), rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 35);
		...
		System.out.println("                perm_memory_peak_usage_map:"+ perm_memory_peak_usage_map);
		...
		for (String server_log_file_error_string : server_log_file_inspection_map.keySet()){
			...
			if (RowspanCnt == 0) {
				RestartFlag = "restart";
			} else if (RowspanCnt == server_log_file_inspection_map.size() - 1){
				RestartFlag = "close";
			} else {
				RestartFlag = "";
			}
			...
			String ErrorOccurCount = server_log_file_inspection_map.get(server_log_file_error_string) + "";
		...
		addTableCellWidth(factory, wordMLPackage, table3_row20, "Server Log", rPrTemplate.tableHeaderRPr, JcEnumeration.CENTER, true, "C6D9F1", 10, 0, "restart");
		addTableCellWidth(factory, wordMLPackage, table3_row20, "OutOfMemoryError", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20, "Heap memory 부족", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20, "1회이상 발생시 기록", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		table3.getContent().add(table3_row20);
		
		Tr table3_row20_1 = factory.createTr();
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "", rPrTemplate.tableHeaderRPr, JcEnumeration.CENTER, true, "C6D9F1", 10, 0, "");
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "Unable to get managed connection", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "JDBC Connection Error", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "1회이상 발생시 기록", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_1, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		table3.getContent().add(table3_row20_1);
		
		Tr table3_row20_2 = factory.createTr();
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "", rPrTemplate.tableHeaderRPr, JcEnumeration.CENTER, true, "C6D9F1", 10, 0, "");
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "Closing a connection for you", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "DB Connection Leak 발생", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "1회이상 발생시 기록", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_2, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		table3.getContent().add(table3_row20_2);
		
		Tr table3_row20_3 = factory.createTr();
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "", rPrTemplate.tableHeaderRPr, JcEnumeration.CENTER, true, "C6D9F1", 10, 0, "");
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "Closing a connection for you", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "DB Connection Leak 발생", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "1회이상 발생시 기록", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_3, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		table3.getContent().add(table3_row20_3);
		
		Tr table3_row20_4 = factory.createTr();
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "", rPrTemplate.tableHeaderRPr, JcEnumeration.CENTER, true, "C6D9F1", 10, 0, "close");
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "Too many open files", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "OS File open 개수 초과", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "1회이상 발생시 기록", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		addTableCellWidth(factory, wordMLPackage, table3_row20_4, "-", rPrTemplate.tableContentRPr, JcEnumeration.CENTER, true, null, 20);
		table3.getContent().add(table3_row20_4);
		*/
		...
		if ("yes".equalsIgnoreCase(ReportUtil.gc_log_file_inspection)){
			...
			if (NumberUtils.isParsable(FullGcAvgInterval)){
				if (Float.parseFloat(FullGcAvgInterval) >= 3000){
			...
			if (NumberUtils.isParsable(MaxGcDuration)){
				if (Float.parseFloat(MaxGcDuration) <= 5){
		...
		if ("yes".equalsIgnoreCase(ReportUtil.gc_log_file_inspection)){
			...
			addTableCellImageWidth(factory, wordMLPackage, table3_row21_2, "data/prod1-GCDuration.png", rPrTemplate.tableContentRPr, 		JcEnumeration.CENTER, true, null, 20, 5, null);
			...
			addTableCellImageWidth(factory, wordMLPackage, table3_row21_3, "data/prod1-HeapMemory.png", rPrTemplate.tableContentRPr, 		JcEnumeration.CENTER, true, null, 20, 5, null);
